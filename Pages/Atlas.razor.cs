...
using MudBlazor;
using NomozVaqtlari.Models;

namespace NomozVaqtlari.Pages;
...
public partial class Atlas
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        var todayPrayerTimeList = new List<(DateTime time, string name)>
        {
            (DateTime.Parse(prayerTimes!.Fajr!), "Fajr"),
            (DateTime.Parse(prayerTimes!.Sunrise!), "Sunrise"),
            (DateTime.Parse(prayerTimes!.Dhuhr!), "Dhur"),
        ...
        var prayerTimesList = todayPrayerTimeList.Concat(tomorrowPrayerTimesList).ToList();
